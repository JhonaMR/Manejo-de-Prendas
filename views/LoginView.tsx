      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in duration-500 py-8">
        <div className="bg-white p-8 sm:p-12 rounded-[40px] sm:rounded-[48px] shadow-2xl border border-white relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            <div className="w-20 h-20 sm:w-28 sm:h-24 bg-gradient-to-br from-blue-500 to-pink-500 rounded-[24px] sm:rounded-[32px] mx-auto flex items-center justify-center text-white font-black text-3xl sm:text-4xl shadow-2xl shadow-blue-200 mb-6">
              Plow
            </div>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tighter">Bienvenido</h1>
            <p className="text-slate-400 font-medium text-sm sm:text-base">Manejo de ventas y producción</p>
          </div>
