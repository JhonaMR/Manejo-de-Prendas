        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 sm:p-8 rounded-[32px] sm:rounded-[40px] shadow-sm border border-slate-100">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input value={confeccionista} onChange={e => setConfeccionista(e.target.value)} placeholder="Ej: Talleres Unidos" className="w-full px-6 py-3.5 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-blue-100 transition-all font-semibold text-slate-900" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase text-blue-500 tracking-widest px-4">Remisión</label>
              <input value={batchCode} onChange={e => setBatchCode(e.target.value)} placeholder="Ej: REM-2023-001" className="w-full px-6 py-3.5 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-blue-100 transition-all font-bold tracking-widest text-slate-900" />
            </div>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <div className="p-4 bg-slate-50 rounded-3xl border border-slate-100 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <p className="text-xs font-black text-slate-500 uppercase tracking-widest">Modalidad</p>
                  <p className="text-[10px] text-slate-400 font-bold">Financiero</p>
                </div>
                <div className="flex gap-2">
