...
const INITIAL_DATA: AppState = {
  ...
  sellers: [
    { id: 's1', name: 'Carlos Vendedor' },
    { id: 's2', name: 'Marta Ventas' }
  ],
  correrias: [
  ...
  references: [
    { id: '10210', description: 'blusa dama', price: 19900, designer: 'Estudio A', cloth1: 'Lino', avgCloth1: 0.85, cloth2: 'Encaje', avgCloth2: 0.15 },
    { id: '12877', description: 'blusa dama', price: 21900, designer: 'Estudio B', cloth1: 'Seda', avgCloth1: 0.90 },
    { id: '12871', description: 'buso dama', price: 25900, designer: 'Estudio A', cloth1: 'Algodon', avgCloth1: 1.2 }
  ],
  clients: [
    { id: '211', name: 'Media naranja', address: 'cll 77 a 45 a 30', city: 'Medellín', seller: 'John' },
    { id: '212', name: 'La pantaleta', address: 'cll 83 # 57 a 14', city: 'Montería', seller: 'Lina' }
  ],
  receptions: [],
  dispatches: [],
  orders: [
